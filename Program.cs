    ...
    public class MyMatrix
    {
        ...
        public MyMatrix(double[][] inputD)
        {
            try
            {
                foreach (double[] arr in inputD)
                {
                    ...
                    {
                        throw new Exception("Êîëè÷åñòâî ñòðîê è ñòîëáöîâ íå ñîâïàäàåò");
                    }
                }
            ...
            {
                Console.WriteLine("Ìàòðèöà íå ÷åòûðåõóãîëüíèê");
            }
        }
        ...
        public MyMatrix(String[] text)
        {
            ...
            try
            {
                for (int i = 0; i < text.Length; i++)
                {
                    ...
                    {
                        throw new Exception("Ìàòðèöà èìååò ðàçíîå êîëè÷åñòâî ýëåìåíòîâ");
                    }
                }
            ...
            {
                Console.WriteLine("Ìàòðèöà èìååò ðàçíîå êîëè÷åñòâî ýëåìåíòîâ");
            }
        }
        ...
        public static MyMatrix operator *(MyMatrix matrix1, MyMatrix matrix2) //de-reference operator *
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Øèðèíà ïåðâîé ìàòðèöû íå ðàâíà âûñîòå âòîðîé");
                }
            ...
            {
                Console.WriteLine("Ìàòðèöà íå óìíîæàåòñÿ");
            }
        ...
        public static MyMatrix operator +(MyMatrix matrix1, MyMatrix matrix2)
        {
            ...
            try
            {
                if (matrix1.Height != matrix2.Height && matrix1.Width != matrix2.Width)
                    throw new Exception("Âûñîòà èëè øèðèíà ïåðâîé ìàòðèöû íå ðàâíû âûñîòå èëè øèðèíå âòîðîé");
            ...
            {
                Console.WriteLine("Ìàòðèöà íå ìîæåò ïðèáàâèòü");
            }
        ...
        {
            String text = "";
            if (this.matrix == null) return "Ìàòðèöà ïóñòà";
            {
                for (int i = 0; i < Height; i++)
                {
                    for (int j = 0; j < Width; j++)
